 ...
 * This event marks the completion of a scan and {@link LoupeStartScanningEvent} marks the start of a scan
 * <br>
 ...
 * research points, etc)
 */
public class LoupeCompleteScanningEvent extends PlayerEvent implements Cancellable {
    ...
    public LoupeCompleteScanningEvent(@NotNull Player player, @NotNull RayTraceResult scanTarget) {
        super(player);
