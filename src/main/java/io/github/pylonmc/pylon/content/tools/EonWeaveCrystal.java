 ...
 * @author balugaq
 */
public class EonWeaveCrystal extends PotionCatalyst {
    ...
    public boolean apply(final Map<PotionEffectType, PotionEffect> effects) {
        ...
        effects.put(type, effect.withDuration((int) (effect.getDuration() * multipleRate)));
        return true;
    }
    ...
    public @NotNull List<@NotNull RebarArgument> getPlaceholders() {
        return List.of(
                RebarArgument.of("multiple-rate", multipleRate),
