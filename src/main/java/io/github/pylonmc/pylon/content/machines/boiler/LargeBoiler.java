...
public class LargeBoiler extends AbstractSolidBoiler {

    public static final Vector3i FUEL_INPUT = new Vector3i(-2, -1, 1);
    public static final Vector3i WATER_INPUT = new Vector3i(-2, -1, 2);
    public static final Vector3i STEAM_OUTPUT = new Vector3i(-2, -1, 3);
    public static final Vector3i SMOKESTACK_CAP_1 = new Vector3i(1, 5, 1);
    public static final Vector3i SMOKESTACK_CAP_2 = new Vector3i(1, 5, 2);
    ...
    public @NotNull Map<@NotNull Vector3i, @NotNull MultiblockComponent> getComponents() {
        ...
        components.put(new Vector3i(-1, 0, 0), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 0), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 0), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 0), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(0, 0, 1), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-1, 0, 1), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 1), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 1), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 1), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(0, 0, 2), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-1, 0, 2), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 2), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 2), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 2), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(0, 0, 3), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-1, 0, 3), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 3), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 3), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 3), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(0, 0, 4), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-1, 0, 4), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 4), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 4), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 4), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(0, 0, 5), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-1, 0, 5), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 5), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 5), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 5), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(0, 0, 6), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-1, 0, 6), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, -1, 6), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(1, 0, 6), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(0, 1, 6), MultiblockComponent.of(Material.BRICKS));

        components.put(new Vector3i(1, -1, 1), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, -1, 2), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 1, 1), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 1, 2), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 2, 1), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 2, 2), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 3, 1), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 3, 2), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 4, 1), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        components.put(new Vector3i(1, 4, 2), MultiblockComponent.of(PylonKeys.SMOKESTACK_RING));
        ...
        components.put(new Vector3i(-2, -1, 2), MultiblockComponent.of(Material.BRICKS));
        components.put(new Vector3i(-2, -1, 3), MultiblockComponent.of(Material.BRICKS));
