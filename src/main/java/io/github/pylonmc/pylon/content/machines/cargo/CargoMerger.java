...
public class CargoMerger extends RebarBlock implements
    ...
    public CargoMerger(@NotNull Block block, @NotNull BlockCreateContext context) {
        ...
        addCargoLogisticGroup(RebarUtils.rotateFaceToReference(getFacing(), BlockFace.EAST), "input");
        addCargoLogisticGroup(RebarUtils.rotateFaceToReference(getFacing(), BlockFace.WEST), "input");
