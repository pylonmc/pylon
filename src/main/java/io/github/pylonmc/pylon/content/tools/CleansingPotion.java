...
public class CleansingPotion extends RebarItem implements SplashPotionRebarItemHandler {
    ...
    public void onPotionSplash(@NotNull PotionSplashEvent event, @NotNull EventPriority priority) {
