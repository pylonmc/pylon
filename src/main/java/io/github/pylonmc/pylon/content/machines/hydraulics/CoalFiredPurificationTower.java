...
public class CoalFiredPurificationTower extends RebarBlock implements
    ...
    public @NotNull Map<@NotNull Vector3i, @NotNull MultiblockComponent> getComponents() {
        ...
        components.put(new Vector3i(0, 1, 0), MultiblockComponent.of(PylonKeys.PURIFICATION_TOWER_GLASS));
        components.put(new Vector3i(0, 2, 0), MultiblockComponent.of(PylonKeys.PURIFICATION_TOWER_GLASS));
        components.put(new Vector3i(0, 3, 0), MultiblockComponent.of(PylonKeys.PURIFICATION_TOWER_GLASS));
        components.put(new Vector3i(0, 4, 0), MultiblockComponent.of(PylonKeys.PURIFICATION_TOWER_GLASS));
        components.put(new Vector3i(0, 5, 0), MultiblockComponent.of(PylonKeys.PURIFICATION_TOWER_GLASS));
        components.put(new Vector3i(0, 6, 0), MultiblockComponent.of(PylonKeys.PURIFICATION_TOWER_CAP));
