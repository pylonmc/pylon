...
public class ElectricTableSaw extends GenericTableSaw implements RebarSimpleElectricBlock {
    ...
    public ElectricTableSaw(@NotNull Block block, @NotNull BlockCreateContext context) {
        super(block, context);
    ...
    @SuppressWarnings("unused")
    public ElectricTableSaw(@NotNull Block block, @NotNull PersistentDataContainer pdc) {
        super(block, pdc);
    }
