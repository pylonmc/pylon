...
public final class PylonBlocks {
    ...
    public static void initialize() {
        RebarBlock.register(PylonKeys.RAW_TIN_BLOCK, Material.IRON_BLOCK, RebarBlock.class);
        ...
        RebarBlock.register(PylonKeys.SULFUR_BLOCK, Material.QUARTZ_BLOCK, RebarBlock.class);
